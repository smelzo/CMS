 <?php require APPLICATION_PATH. DIRECTORY_SEPARATOR ."admin". DIRECTORY_SEPARATOR ."admin.head.php";?>
...
<link rel="stylesheet" type="text/css" href="simplex/css/admin.css"/>
    ...
    <?php if ($user['power']>0) : ?>
    <div id="admin-toolbar" class="navbar">
        <ul id="admin-menu">
...
<?php else :?>
<a id="login-show-link" class="hide" href="#" rel="tooltip" data-placement="top" title="[:accedi:]">
