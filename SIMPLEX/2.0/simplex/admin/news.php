        ...
        <div class="" id="center-pane">
            <div class="pane-content">
                ...
                <form id="form-news" class="" data-role="main-form">
                        <div class="row-fluid">
                            <div class="span8">
                              <label for="title" style="line-height: 36px;margin: 0">Titolo</label> <input name="title" type="text" class="field mandatory full-width k-textbox" >
                            </div>
                            <div class="span4">
                                <div class="row-fluid">
                                    <div class="span4">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><a id="ctrl-contenuto" href="#tab-contenuto" data-toggle="tab">Contenuto</a></li>
