...
;(function ($){
    ...
    function open_images_dialog(url,options){
        if(typeof url == 'undefined' || !url) url = 'simplex/filemanager/index.php?m=images&t=images&dtv=' + ((new Date).valueOf()) ;
        options = $.extend( {
            url_params :null
        },  options||{});
...
;(function ($){
    function open_file_dialog(url,options){
        if(typeof url == 'undefined' || !url) url = 'simplex/filemanager/index.php?m=files&t=web&dtv=' + ((new Date).valueOf()) ;
        console.log(url);
        options = $.extend( {
            url_params :null
        },  options||{});
        ...
        var el = $('<div class="open_file_dialog-host"></div>')
        .appendTo('body');
        var win= el.kendoWindow({
                iframe :true,
                modal:true,
    ...
    window.open_file_dialog = open_file_dialog;
})(jQuery);
;(function($, undefined) {
