...
;(function($){
	$.contextMenu = {
		...
		createMenuItem: function(label,obj) {
			...
			var $idiv = $('<div class="'+cmenu.innerDivClassName+'" style="'+iconStyle+'">'+o.label+'</div>');
			$div.append($idiv);
			return $div;
		},
		...
		afterHide: function() { return true; },
		...
		show: function(t,e) {
			...
			if (cmenu.beforeShow()!==false) {
				...
				cmenu.shown=true;
				cmenu.afterShow.call(cmenu,t,e);
