...
<script type="text/javascript" src="simplex/admin/cats.js?dt=<?php echo date()?>"></script>
...
<script id="mainimage-empty-template" type="text/html">
    <div class="thumb-placeholder thumb-empty" style="height: 100px">
            ...
            <div class="pane-content">
                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <div>
                            <input class="span3 field nospace"  maxlength="50" name="name" type="text" placeholder="nome"/>
                        </div>
                        <?php
                    ...
                    <div class="span6">
                        ...
                        <div id="main-image" class="thumbnail reduced"></div>
                    </div>
                </div>
                <div class="row-fluid">
                    <div id="description-tabs" class="span12">
                         <p><label for="">Descrizione</label></p>
                        <?php
                            $tabs = array();
                            $panes = array();
                            $c = 0;
                            ...
                            $active = (!$c)?'active':'';
                                ob_start();
                            ?>
                            <li id="tab-<?php echo $lg?>" class="tab-pane <?php echo $active ?>">
                                <a href="#tab-description-<?php echo $lg?>"  data-toggle="tab-impl"><?php echo $language?></a>
                            </li>
                            <?php
                                $tab = ob_get_clean();
                                $tabs[]=$tab;
                                ob_start();
                            ?>
                            <div id="tab-description-<?php echo $lg?>" class="tab-pane-impl <?php echo $active ?>">
                                <textarea class="field" name="description" lang="<?php echo $lg?>" style="height: 150px;width:500px"></textarea>
                            </div>
                            <?php
                                $pane = ob_get_clean();
                                $panes[]=$pane;
